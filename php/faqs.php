...
<head>
    ...
    <title>FAQs | Montra Studio</title>
    ...
    <main> <br/><br/><br/><br/><br/><br/>
        <div class="page-container">
            ...
            <div class="faq-item">
                ...
                <p>You can book a session by navigating to our "Services" page, choosing your desired package, and selecting an available date and time from the calendar. You must be logged in to complete a booking.</p>
            </div>

            <div class="faq-item">
                <strong>What is included in a photo session?</strong>
                <p>Each package lists its specific inclusions. Generally, all packages include a set amount of studio time, a choice of backdrops, professional lighting, and a number of professionally retouched digital photos. Please check the specific package for details.</p>
            </div>

            <div class="faq-item">
                <strong>How do I see my photos after the session?</strong>
                <p>Once your photos are ready, they will be uploaded to your personal "My Album" section in your profile. You will also receive a notification when they are available.</p>
            </div>

            <div class="faq-item">
                <strong>Can I reschedule my booking?</strong>
                <p>Yes, you can reschedule up to 48 hours before your scheduled session. Please go to your "Pending Bookings" page to manage your appointment or contact us directly for assistance.</p>
            </div>
        </div>
    </main>

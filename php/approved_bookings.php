...
$approved_bookings = $result2->fetch_all(MYSQLI_ASSOC);
$stmt2->close();
$conn->close();
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Approved Bookings | Montra Studio</title>
  <link rel="stylesheet" href="../css/profile.css">
  <link rel="stylesheet" href="../css/footer.css">
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
  <style>
    body { font-family: 'Inter', sans-serif;  background-color: #fff9f9; margin:0; }
  ...
  <div class="profile-container">
    <div class="profile-card">
      ...
      <?php if (empty($approved_bookings)): ?>
        <p class="text-muted">You currently have no approved bookings.</p>
      <?php else: ?>

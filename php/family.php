<?php
// --- Start: Logic from your advanced header ---
session_start();
...
// --- Start: Original Logic from family.php ---
...
// --- End: Original Logic from family.php ---
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
      ...
      /* Dropdown profile styles (from advanced header) */
...
<body>
  ...
  <header class="header">
    <div class="">
      <a href="../php/homepage.php"><img src="../images/LOGO.png" alt="Montra Studio Logo" style="height: 100px; width: 300px;">
</a>
    </div>
  ...
  <section class="service-package">
    <div class="package-card">
      <div class="package-img">
        <img src="../uploads/<?= htmlspecialchars($package['main_image']) ?>" alt="Family Package">
      </div>
  ...
  <div class="price-box">
    ...
    <?php if ($isLoggedIn): ?>
      <a class="service-card" href="../php/booking.php?package=family&price=<?= $package['price'] ?>">
    ...
    <div class="package-details">
      <h3>All in One Frame Package Includes:</h3>
      <ul>
  ...
  <script>
    ...
    // Added checks in case next/prev buttons aren't in this carousel

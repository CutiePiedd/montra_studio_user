...
// --- Start: Original Logic from squad.php ---
$isLoggedIn = isset($_SESSION['user_id']); // Kept for the "Book Now" button logic

$id = 1; // Squad package ID
...
// --- End: Original Logic from squad.php ---
?>
...
.header-right {
      ...
      .profile-icon { 
        ...
        margin-right: 77px; /* <--- ADD THIS LINE */
      }
      /* ... (rest of your styles) ... */
      .header {
        position: fixed;
        z-index: 10;
        /* Assuming header styles are in a shared CSS, but just in case: */
        width: 100%;
      ...
      /* Simple btn class for login, if not defined in CSS */
      .btn.outline {
        padding: 8px 16px;
